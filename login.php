...
<body>
    ...
    <div class="container mt-3">
        ...
        <form action="login.php" method="POST">
            ...
            <button type="submit" name="btn_login" class="btn btn-primary mt-3">เข้าสู่ระบบ</button>
        </form>
        <p>หากคุณต้องการสมัครสมาชิก<a href="register.php">Click</a></p>
        <hr>
        <a href="em_login.php" class="btn btn-warning">ระบบพนักงาน</a>
    </div>
